...
<head>
    ...
    <link rel="stylesheet" href="./css/elibrary-styles.css">
    ...
    <script defer src="./js/elibrary-app.js"></script>
</head>
<body>
    <header>
        <!-- Start Navbar -->
        <nav class="navbar navbar-expand-lg navbar-dark bg-info">
            <a style="padding-right: 2em;" class="navbar-brand" href="index.html">The eLibrary <sup>&reg;</sup> ::: CS472-WAP project</a>
            ...
            <div class="collapse navbar-collapse" id="navbarColor01">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item active" style="border-left: white 1px solid; padding-left: 2em; padding-right: 2em;">
                        <a class="nav-link" href="/cs472lab/viewcontactus">Books</a>
                    </li>
                </ul>
